...
### This is a content managment system interface to allow a manager to track employee data such as salary, role, and department. The manager can view all departments, roles, or employees. They can add departments, roles, and employees, and they can update employee roles. This project uses the MySQL2 package to connect to a MySQL database and perform queries, the inquirer package, to interact with the user via the command line, and the console.table to make MySQL rows print nicely in the console.
